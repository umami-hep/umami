...
import h5py
import tempfile
from umami.preprocessing_tools import check_size, check_keys, \
    check_shapes, get_size, create_datasets, add_data
...
class Check_ShapesTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_h5_1.create_dataset('test', data=np.ones(10))
        self.test_h5_2.create_dataset('test', data=np.ones(10))
        self.test_h5_3.create_dataset('test', data=np.array(
...
class Create_DatasetsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_reference_h5 = \
            h5py.File(self.test_reference_h5_file_name, 'w')
